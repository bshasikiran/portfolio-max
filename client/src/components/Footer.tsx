    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="text-2xl font-bold font-poppins mb-6 md:mb-0">
            <span className="text-white">Shasi</span>
          ...
          <div className="flex space-x-6">
            <a
              ...
              className="social-icon hover:text-primary-400 transition-all duration-300 hover:-translate-y-1 hover:scale-110"
            >
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; 2025 Betala Shasi Kiran. All rights reserved.</p>

          <div className="mt-4 md:mt-0">
            <ThemeToggle className="bg-gray-800 text-gray-400 hover:text-white" />
          </div>
        </div>
      </div>
    </footer>
